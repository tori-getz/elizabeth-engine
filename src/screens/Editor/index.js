    ...
    render () {
        return ( 
            <div>
                ...
                {this.props.opened.viewport ? <Viewport /> : ""}
                ...
                <CommandBar
                    ...
                    primaryCommands={[
                        ...
                        <AppBarButton icon="Video" label="Viewport" onClick={this.props.openViewport} />,
...
function mapDispatchToProps (dispatch) {
    return {
        ...
        openViewport: () => dispatch({ type: "OPEN_WINDOW", payload: "viewport" })
    };
}
